                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="needs-validation" id="createUkmForm" novalidate>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputUkmAddress" name="ukm_address" placeholder="Masukkan Alamat UKM" required>
...
<script>
    $(document).ready(function() {
        ...
        $('#createUkmForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/ukm/store', // Ganti dengan URL tujuan pengiriman data
                data: formData,
