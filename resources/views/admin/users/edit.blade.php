            ...
            <div class="col-xl-8 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Form Edit Pengguna</h5>
                        <form class="needs-validation" id="updateUserForm" novalidate>
                            <div class="row mb-3">
                                <label for="inputUkmName" class="col-sm-3 col-form-label">Nama</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputUkmName" name="name" placeholder="Masukkan Nama pengguna" value="{{ $user->name }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputIdentity" name="identity_number" placeholder="Masukkan No KTP" value="{{ $user->identity_number }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select mb-3" name="status" aria-label="Default select example" required>
                                        <option value="1" {{ $user->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="0" {{ $user->status == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
